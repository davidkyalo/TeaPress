...
class Translator extends NamespacedItemResolver implements TranslatorInterface, ArrayAccess
{
	/**
	 * The loader implementation.
	 *
	 * @var \TeaPress\Translation\LoaderInterface
	 */
	protected $loader;
	 ...
	 *
	 * @param  \TeaPress\Translation\LoaderInterface  $loader
	 * @param  string  $locale
	 * @return void
	 */
	 ...
	 * @return void
	 */
	public function set($key, $lines, $locale = null)
	{
		...
		Arr::set($this->loaded[$namespace][$group][$locale], $item, $lines);
	}
